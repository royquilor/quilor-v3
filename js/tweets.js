...
const tweets = [
  ...
  },
  {
    ...
    copy: "iOS users who want to check IVs quickly should take a look at this video. The website I used to copy the string is http://hundoiv.com  so you should check it out! Feel free to share! Note: Always appraise as CP can be the same for different levels. #PokemonGO",
    name: "@pkmnsnaps",
...
const updateTweet = function() {
  ...
  titleTag.innerHTML = tweets[tweetNumber].title
